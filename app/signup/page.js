...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 min-h-screen">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input name="email" id="email" placeholder="hello@example.com" type="email" autoComplete="email" required />
            </div>
            <div className="space-y-2">
